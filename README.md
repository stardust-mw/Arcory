...
| AboutPortrait | `components/about-portrait.tsx` | About 页面 Gallery 图像组件（多格式自动探测 + 回退） |
...
- 人像素材：
  - 推荐放置：`public/portrait.webp`（优先）
  - 兼容回退：`portrait.png` / `portrait.jpg` / `portrait.jpeg`
